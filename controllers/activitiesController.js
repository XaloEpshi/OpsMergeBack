...
exports.getAllActivities = async (req, res) => {
    try {
        ...
        const [exportaciones] = await pool.query('SELECT "Exportaciones" AS origen, fechaCarga AS fecha_hora, CONCAT(material, " exportado a ", mercado) AS actividad, observacion AS descripcion, turno, "" AS user_id FROM exportaciones');
